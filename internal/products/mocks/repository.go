...
func (m *MockRepository) GetProductsByRestID(restID, count, page uint64) ([]*models.Product, uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetProductsByRestID", restID, count, page)
...
func (mr *MockRepositoryMockRecorder) GetProductsByRestID(restID, count, page interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetProductsByRestID", reflect.TypeOf((*MockRepository)(nil).GetProductsByRestID), restID, count, page)
}
